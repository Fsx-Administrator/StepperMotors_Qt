...
public:
    ...
    [[nodiscard]] static inline Position inverseFactor(const Qt::Axis axis) noexcept { return inverseFactor_[axis]; }
    ...
    [[nodiscard]] QString positionAsString(const Qt::Axis axis) const noexcept;
...
private:
    static inline std::array<Position, 3> inverseFactor_ = {};
